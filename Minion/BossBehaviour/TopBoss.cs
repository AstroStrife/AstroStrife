...
public class TopBoss : NetworkBehaviour, IDamageable
{
    private Animator _animator;
    [SerializeField] private GameObject minion_dead_prefab;
    private Transform currentTarget = null;

    public UnitData BossTop;
    ...
    public void TakeDamServerRpc(float Damage, ulong attackerID, string attackerName)
    {
        ...
        if (HP.Value <= 0)
        {
            ...
            GameManager.Instance.GiveBossTopBuffTeam(attackerID);
            HP.Value = MaxHP.Value;
    ...
    {
        poolManager.poolDictionary[gameObject.tag + "_" + "BossTop"].Enqueue(gameObject);
