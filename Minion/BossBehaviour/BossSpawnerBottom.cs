...
public class BossSpawnerBottom : NetworkBehaviour
{
    ...
    private void Start()
    {
        ...
        if (IsServer)
        {
            SpawnObjectServerRpc("OffLane", "BossBottom", this.gameObject.transform.position, this.gameObject.transform.rotation);
        }
    }
